...
import { Monitor, RefreshCw, RotateCcw, Phone, CheckCircle, Heart, Baby, Users } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <Button variant="ghost" size="sm" onClick={refresh} title="Atualizar">
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center justify-between mb-2">
                        <span className="font-bold text-lg">Baia {baiaNum}</span>
                        {person && (
                      ...
                      {person ? (
                        <>
                          <p className="text-sm text-slate-600 mb-2">{person.name}</p>
                          <Button
                            size="sm"
                            onClick={() => completeBaia(person.id)}
          ...
          <div className="space-y-6">
                ...
                {dpQueue.length === 0 ? (
                  ...
                  dpQueue.map((person) => (
                    <div key={person.id} className="flex items-center justify-between p-3 bg-violet-50 rounded-lg border border-violet-200">
                      ...
                      <Button size="sm" variant="outline" onClick={() => completeDP(person.id)}>
                        Finalizar
                      </Button>
                    </div>
                  ))
            ...
            {dpQueue.length > 0 && (
              <Card className="border-violet-200 bg-violet-50">
                <CardContent className="p-4">
                  <Button onClick={callForDP} className="w-full bg-violet-600 hover:bg-violet-700">
                    <Phone className="w-4 h-4 mr-2" />
